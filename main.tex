...
which sped up by \speedupRshStrict, we see a slightly less gains in performance.
We conclude that indeed the optimizing compiler seems to benefit even more from
eager semantics than the interpreter.
