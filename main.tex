...
Fig.~\ref{pipe} shows the full pipeline, it starts with extracting
...
\config 1 is surprising, as making reflective arguments strict hides 5 errors,
...
while S and R are the cause of most errors. We conclude that \config 0 is safe
