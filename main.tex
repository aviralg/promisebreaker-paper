...
sows four possible invocations. For \c{r1}, any signature that has at least
...
trace exposes the raw R objects that are being operated on by the program as
well as the control flow through the code.
...
%Table~\ref{table:argeval} shows the number and proportion of
...
%  \small
%  \centering
%  \caption{Indirect Effects} \label{table:transeffects}
%  \begin{tabular}{llll}
%    \toprule
