...
experiment and does not involve \strictr in any ways (which is
a testing tool not intended to provide speedup). 
...
would, instead, re-write externally provided annotatted functions and rely on already
