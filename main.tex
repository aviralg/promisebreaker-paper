...
function's name and $s_i$ are positions of arguments that can be evaluted
strictly.

However, the intricacies of R introduce many challenges. The first challenge is
treatment of $...$, or varargs. $...$ paramaters accept arbitrary number of
arguments including zero. These are typically used for two reasons: \emph{(a)
   }
