...
invoked, the trace records all operations related to arguments and correlates
them with parameters.
%% TODO: this sentence does not parse...
For each operation performed by the interpreter, the
