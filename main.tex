...
There are 50,435 top-level functions; \CorpusTwentyFivePackageCount packages
have 25 functions or less, and \CorpusFiveHundredPackageCount packages with more
than 500 functions. The largest package, \texttt{\CorpusMaximumFunctionPackage},
has \CorpusMaximumFunctionCount functions. We observe 137.2M calls to these
