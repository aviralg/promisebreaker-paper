...
\item We extend the \Rsh optimizing just-in-time compiler with support for
  ...
  a median 1.12x speed up on those benchmarks.
...
In this section we report on our implementation of strictness annotations in
\Rsh an optimizing just-in-time compiler for R.
