...
errors. Technically, reads are not an effect. For the purpose of this work
we classify it as such because of its interplay with writes. A write is an
...
\section{\Rsh: Compiling the Lazy Away}
