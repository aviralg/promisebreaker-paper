...
collection pressure; and there is an additional speedup due to improved compiler
optimizations.
...
\paragraph{Effects on Garbage Collection}
...
are still bundled in promises and special forms, \ie R builtins with a custom evaluation
