...
Specifically, it should be the case that changes
...
small and the precision of the inference is promising. For community review we intend
...
reference implementation. It is conceivable that the relative speedups could be more
impressive than in our native compiler, but in the long run we expect users
to move away from bytecode interpretation.
