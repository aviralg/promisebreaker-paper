...
for \TotalParameterCount parameters of \TotalFunctionCount functions of which
\TotalStrictParamCount (\TotalStrictParamPerc) parameters are strict. When the
output of this second run differs from the one obtained by GNU R, the difference
...
course, be differences in execution that does not manifest in the output; so
these results reported here are a lower bound.
