...
effectiveness of our signatures. Then, we run these programs eight time, once
for each signature configuration, and count the number of programs that fair or
produce a different output compared to the baseline output. The results are
summarized in Table~\ref{table:strictfail}. The rows represent signature
configurations. For each configuration we report the number and percentage of
failing programs, further broken down into failures per script type.
