...
\lazr only handles reads and writes to R environments from R and native code; it
does not handle IO. The R ecosystem has a rich collection of libraries for
