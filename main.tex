...
\TotalArgumentCount arguments, of those, \MissingTotalCountArguments are missing,
\VarargParameterCount are varargs, and the remaining are promises. These
arguments correspond to \TotalParameterCount parameter positions; 7\% of
functions have no parameters, 19\% have 1, and 5\% have over 10, and 15
functions have over 50 parameters. Function
