...
effectiveness of our signatures. We extracted XXXX runnable programs from the
2000 client packages from which XXXX programs yielded the same result on both
runs. These are the programs against which we present the outcome of applying
our signatures.
...
output. In our baseline deterministic programs, XXXX\% had unique outputs.
This will be then be counted as a failure for that signature
configuration.
