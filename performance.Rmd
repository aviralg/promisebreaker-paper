...
selection <- c(
  "Bounce",
  "Mandelbrot",  # are-we-fast-r version
  "Storage",
  "Flexclust",
  "Binarytrees",
  "Fasta",
...
```{r echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
H3.2a <- function() {
  prom <- fetch_jobs(promiseReductionExperiment, addWarm = TRUE, warmup = 5, iterations = 15)
  ...
  prom$benchmark = paste0(lapply(prom$benchmark, printable_name), "")
